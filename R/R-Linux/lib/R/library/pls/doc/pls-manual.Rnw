%% $Id: pls-manual.Rnw 245 2015-07-25 15:47:29Z bhm $
...
\and
  ...
  Center for Research and Innovation, Fondazione Edmund Mach\\
...
decrease. Unfortunately, no generally applicable tests are available,
so the decision on how many components to retain will always be
