...
def getSampleCatTree(request):
    ...
    list = ['sample_name', 'organism', 'collection_data', 'depth', 'elev', 'seq_platform', 'seq_gene', 'seq_gene_region', 'seq_for_primer', 'seq_rev_primer', 'env_biome', 'env_feature', 'env_material', 'geo_loc_country', 'geo_loc_state', 'geo_loc_city', 'geo_loc_farm', 'geo_loc_plot']
...
def getSampleCatTreeChildren(request):
    ...
    if request.is_ajax():
        ...
        mimark = ['sample_name', 'organism', 'collection_data', 'depth', 'elev', 'seq_platform', 'seq_gene', 'seq_gene_region', 'seq_for_primer', 'seq_rev_primer', 'env_biome', 'env_feature', 'env_material', 'geo_loc_country', 'geo_loc_state', 'geo_loc_city', 'geo_loc_farm', 'geo_loc_plot']
